<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Drugs_04_1.aspx.cs" Inherits="Form_Drugs_04_1" %>
...
<script>
    ...
    function LoadPics() {
        //加载图片
        var inputObject = $(document).find('.con');
        
        for (let i = 0; i < inputObject.length; i++){

            var imagelist = $(inputObject[i]).find('img');
            ...
            for (let j = 0; j < imagelist.length; j++) {
                ...
                if (drugid) {
                    ...
                    $.ajax("../Ajax/LoadDrugMedia.ashx", {
                        ...
                        dataType: 'json', //服务器返回json格式数据//text
                        type: 'post', //HTTP请求类型	
                        timeout: 8000,
